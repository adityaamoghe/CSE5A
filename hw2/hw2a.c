 ...
 * General description of the program:
 The program gives the user options of adding unlimited toppings to their regular $10 pizza.
 Numbers 2-9 add toppings, whereas 0 places the order and one resets the order*/
...
/*
 * General description of the main function: The main function loops the menu screen for as long as the user keeps adding toppings.
...

{
    ...
    int countOfToppings;   //number of toppings added
    ...
    //The do-while loop will repeat the menu for as long as the user inputs an order placement.
